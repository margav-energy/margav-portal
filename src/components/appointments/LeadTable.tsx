 ...
 * Unallocated views, which only differ in the leads they're handed.
 */
export function LeadTable({ leads, emptyMessage = "Nothing to show!" }: { leads: RtaLead[]; emptyMessage?: string }) {
